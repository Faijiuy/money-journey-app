...
firestore.collection("category").get()
  .then(data => {
    data.forEach(doc => {
      ...
      categories.push({ id: category_i, name: doc.data().name })
    })
  })
  ...
  return (
    <Container>
      <Row>
        <Col>
          <h1>Journal</h1>
          <Button variant="info" onClick={handleshowForm}>
            <BsPlus /> Add
      </Button>
        </Col>
        <Col>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Row>
              ...
              <Col>
                <input
                  ...
                  name="createdAt"
                  id="createdAt"
                  defaultValue={tempData.createdAt}
          ...
          <Modal.Footer>
            ...
            <Button variant={editMode ? "success" : "primary"} type="submit" onClick={addNewJournal}>
...
function JournalRow(props) {
  let d = props.data
  var category_display = "uncategorized"
